...
<!-- Generated by scripts/sync_skills.py from .claude/commands/strategy/data-scientist.md. Do not edit. -->

In Claude Code this skill is `/strategy:data-scientist`.
