...
<!-- Generated by scripts/sync_skills.py from .claude/commands/roster/set-lineup.md. Do not edit. -->

In Claude Code this skill is `/roster:set-lineup`.
