...
<!-- Generated by scripts/sync_skills.py from .claude/commands/strategy/team-report.md. Do not edit. -->

In Claude Code this skill is `/strategy:team-report`.
