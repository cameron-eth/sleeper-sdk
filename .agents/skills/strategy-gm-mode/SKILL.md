...
<!-- Generated by scripts/sync_skills.py from .claude/commands/strategy/gm-mode.md. Do not edit. -->

In Claude Code this skill is `/strategy:gm-mode`.
