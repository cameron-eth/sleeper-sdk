...
<!-- Generated by scripts/sync_skills.py from .claude/commands/trades/proposed.md. Do not edit. -->

In Claude Code this skill is `/trades:proposed`.
